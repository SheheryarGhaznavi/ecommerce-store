...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-04.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:34 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
			...
			<header id="header" class="header-layout-04">
				...
				<div class="container">
					<div class="row text-center">
						...
						<!-- / -->
						<!-- logo start --> 
						<a href="index.html"><img class="logo replace-2x img-responsive" src="images/logo-transparent.png" alt=""/></a> 
						<!-- logo end --> 
					</div>
				</div>
				<!-- nav -->
			...
			<div class="tp-banner-container">
				<div class="tp-banner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/slides/04/intro_img_01.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS -->												
						</li>
						<!-- /SLIDE 2  -->
						<!-- SLIDE 3  -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/slides/04/intro_img_02.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS --> 
