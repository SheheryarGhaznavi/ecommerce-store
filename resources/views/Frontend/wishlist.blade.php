...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:40:48 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
	...
	<body>
		...
		<div id="pageContent">
			<div class="container">				
				<!-- title -->
				<div class="title-box">
					<h1 class="text-center text-uppercase title-under">MY WISHLIST</h1>
				</div>
				<!-- /title -->
				<!-- table -->
					...
					<tbody>
						<tr>
								...
								<table>								
									<tbody>
										<tr>
											...
											<td>
												<div class="visible-sm visible-xs pull-right visible-icon">
													<a href="#" class="icon icon-create"></a>
													<a href="#" class="icon icon-delete"></a>
												</div>
												<h5 class="table-wishlist__product-name text-uppercase color">Mauris lacinia lectus</h5>
												...
												<div class="visible-sm visible-xs">
													<p>
														<span class="table-wishlist__product-price">$28.00</span>
													</p>
													<div class="table-wishlist__input"><input type="text" class="form-control" placeholder="1"></div>					
													<p>
														<a href="#" class="btn btn--ys btn--xl btn--xl-small"><span class="icon icon-shopping_basket"></span> Add to cart</a>
													</p>																					
												</div>
												<form >
													<div class="form-group">
														<textarea class="form-control" rows="7" placeholder="Please, enter your comments..."></textarea>
													</div>
													<div class="divider divider--xs"></div>
													<a class="btn btn--ys btn--sm--icon btn--light" href="#"><span class="icon icon-autorenew"></span>Update Wishlist</a>
												</form>
											</td>
										</tr>
									</tbody>
							...
							<td>
								...
								<p>
									<a class="btn btn--ys btn--light" href="#"><span class="icon icon-create"></span>Edit</a>
								</p>
							</td>
							<td>
								<a class="table-wishlist__delete icon icon-clear" href="#"></a>
							</td>
						</tr>
						<tr>
							<td>
		        ...
		        <div class="row wishlist-button">
		        	<div class="col-xs-12 col-lg-2 pull-left">
		        		<a href="#" class="link-functional"><span class="icon icon-keyboard_arrow_left"></span>back</a>
		        	</div>
		        	<div class="divider divider--xs visible-xs"></div>
		        	<div class="col-xs-12 col-lg-10 text-right">
		        		<a class="btn btn--ys btn--light btn-right" href="#"><span class="icon icon-autorenew"></span>Update Wishlist</a>						
		        		<div class="divider divider--xs visible-sm visible-xs"></div>
		        		<a class="btn btn--ys btn--light btn-right" href="#"><span class="icon icon-share icon--flippedX"></span>Share Wishlist</a>
		        		<div class="divider divider--xs visible-sm visible-xs"></div>
		        		<a href="#" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket "></span> ADD ALL TO CART</a>
		        	</div> 	
