...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/listing-col-right_03.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:54 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
				...
				<div class="row">
					...
					<aside class="col-md-8 col-lg-9 col-xl-10" id="centerColumn">
						...
						<div class="filters-row">
							<div class="pull-left">
								<div class="filters-row__mode">
									<a href="#" class="btn btn--ys slide-column-open visible-sm">Filter</a>
									<a class="filters-row__view active link-grid-view btn-img btn-img-view_module"><span></span></a>
									<a class="filters-row__view link-row-view btn-img btn-img-view_list"><span></span></a>
								</div>
								<div class="filters-row__select hidden-sm hidden-xs">
					...
					<aside class="col-md-4 col-lg-3 col-xl-2 hidden-xs hidden-sm" id="rightColumn">
						...
						<div class="collapse-block open">
							...
							<div class="collapse-block__content">
								<p class="under-form-text color">What is your favorite color</p>
								<form id="pollForm3" action="#">
									<ul class="filter-list">
										<li>
											<label class="radio">
											<input id="radio12" type="radio" name="radios" checked>
											<span class="outer"><span class="inner"></span></span>Green</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio22" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Red</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio32" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Black</label>
										</li>
										<li>
											<label class="radio">
											<input id="radio42" type="radio" name="radios">
											<span class="outer"><span class="inner"></span></span>Magenta</label>
										</li>
									</ul>
									<button type="submit" class="btn btn--ys btn--md btn--light">Vote</button>
