...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:44 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
				...
				<div class="container offset-top-5">
					<div class="row">
						...
						<div class="col-xs-12 col-md-3 col-lg-3 col-xl-3 col-sm-3">
							<!-- logo start --> 
							<a href="index.html"><img class="logo replace-2x img-responsive" src="images/custom/layout10/logo.png"  alt=""/></a> 
							<!-- logo end --> 
						</div>
						<!-- /col-left -->						
						<!-- col-right -->										
				...
				<div class="tp-banner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/custom/layout10/slides/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" > 
							<!-- LAYERS --> 							
						</li>
						<!-- /SLIDE -1 -->
						<!-- SLIDE 2  -->            
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/custom/layout10/slides/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS -->										
						</li>
						<!-- /SLIDE 2  -->
						<!-- SLIDE 3  -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/custom/layout10/slides/slide-3.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS --> 							
						</li>
						<!-- /SLIDE 3  -->
						<!-- SLIDE 4  -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/custom/layout10/slides/slide-4.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS --> 							
						</li>
						<!-- /SLIDE 4  -->		  
						<!-- SLIDE 5  -->
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/custom/layout10/slides/slide-5.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS --> 							
						</li>
						<!-- /SLIDE 5  -->
					</ul>
		...
		<div id="pageContent">
			...
			<div class="container-fluid box-baners">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<!-- banner -->
						<a href="listing-layout10.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/layout10/banner-01.jpg" alt=""/>
						...
						<a href="listing-layout10.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/layout10/banner-03.jpg" alt=""/>
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<a href="listing-layout10.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/layout10/banner-02.jpg" alt=""/>
								<span class="figcaption text-left">
									<span class="block-table">
										<span class="block-table-cell">
						...
						<a href="listing-layout10.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/layout10/banner-04.jpg" alt=""/>
								<span class="figcaption text-right-small">
									<span class="block-table">
										<span class="block-table-cell">
							...
							<div class="product">
								<div class="product__inside">
									...
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-01.jpg" alt=""> </a> 
										<!-- quick-view --> 
						...
						<div class="col-lg-3">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-02.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
										<!-- /quick-view --> 
									</div>
									<!-- /product image --> 										<!-- label news -->
						...
						<div class="col-lg-3">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-03.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-lg-3">
							...
							<div class="product sold-out">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-04.jpg" alt=""> </a> 
										<!-- label sold-out -->
						...
						<div class="col-lg-3">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-05.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
										<!-- /quick-view --> 
									</div>
						...
						<div class="col-lg-3">
							...
							<div class="product">
								<div class="product__inside">
									<!-- product image -->
									<div class="product__inside__image">
										<a href="product-layout10.html"> <img src="images/custom/layout10/products/product-06.jpg" alt=""> </a> 
										<!-- quick-view --> 
										<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
										<!-- /quick-view --> 
									</div>
			...
			<div class="container-fluid box-baners content">
				<div class="row">					
					<div class="col-xs-12">
						<!-- banner -->
						<a href="listing-layout10.html" class="banner banner-bg image-bg zoom-in" data-image="images/custom/layout10/banner-05.jpg">
							<span class="figure">
								<img src="images/custom/layout10/banner-05.jpg" alt=""/>
				...
				<div class="container">
					<div class="row">
						<div class="brands-carousel">
							<div><a href="#"><img src="images/custom/layout10/brand-01.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-02.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-03.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-04.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-05.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-06.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-07.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-08.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-09.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-10.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-01.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-02.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-03.png" alt=""></a></div>
							<div><a href="#"><img src="images/custom/layout10/brand-04.png" alt=""></a></div>
		    ...
		    <div class="modal-content modal-md">
		      ...
		      <div class="modal-block">
			      ...
			      <div class="modal-newsletter text-center">
			      	    <img class="logo replace-2x img-responsive1" src="images/custom/layout10/logo.png" alt=""/>
