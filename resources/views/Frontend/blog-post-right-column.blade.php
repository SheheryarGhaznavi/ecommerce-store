...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/blog-post-right-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:44:33 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
					...
					<div class="col-xl-8 col-lg-8 col-md-12" id="centerColumn">
						...
						<div class="post">
							...
							<div class="post__title_block">
								...
								<div class="pull-left">
									<h2 class="post__title text-uppercase"><a href="#">Markup: Image Alignment</a></h2>
							...
							<p>
								<img src="images/blog/post-img-01.jpg" class="img-responsive" alt="">
							</p>
						...
						<div class="media comments">
						  ...
						  <div class="media-body">
						    <div class="media-title">
						    	<a href="#" class="pull-right link">reply</a>
						    	<span class="username">by <b>Admin</b></span>
						    	<div class="time"><span class="icon icon-access_time"></span>June 30, 2015 at 7:16 am</div>
						    </div>
						    <div class="media-content">
						    	<p>
							    	Dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
							    </p>
						    </div>
						  </div>
						  <!-- /content -->
						...
						<form>
						  ...
						  <div class="form-group">
						    ...
						    <textarea class="form-control"  id="InputComment" rows="8"></textarea>
						  </div>
