...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-07.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:38 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
							...
							<div class="search-outer visible-mobile-menu-off">
								<form id="search__form" action="#" method="get">
									<div class="input-outer">
										<input id="search" type="search" name="search" value="" maxlength="128" placeholder="SEARCH...">
							...
							<ul>
								...
								<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
									...
									<div class="tp-caption lfr str" 
										...
										<div class="tp-caption--product-1">
											...
											<a href="#" data-toggle="modal" data-target="#modalAddToCart" class="btn btn--ys btn--lg btn-top"><span class="icon icon-shopping_basket"></span> Add to cart</a>
										</div>								
									</div>
								</li>
								<!-- /SLIDE -1 -->
								...
								<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
						            ...
						            <div class="tp-caption  lfl ltl" 
										...
										data-easing="Power4.easeOut"
										style="z-index: 5;">
											<img src="images/slides/07/slide-2-item_01.html" alt="Image01">
									</div>
									<!-- IMAGE NR. 02 -->
						            <div class="tp-caption  lfl ltl" 
										data-x="639" 
								...
								<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
						            ...
						            <div class="tp-caption  lfb ltt" 
										...
										data-easing="Power4.easeOut"
										style="z-index: 5;">
											<img src="images/slides/07/slide-3-item_01.html" alt="Image01">
									</div>
									<!-- IMAGE NR. 02 -->
						            <div class="tp-caption  lfb ltt" 
										data-x="639" 
						...
						<div class="bannerCarousel box-baners ">
							<div class="col-md-3">
								<a href="listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-17.jpg" alt=""/>
							...
							<div class="col-md-3">
								<a href="listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="images/custom/banner-21.jpg" alt=""/>
							...
							<div class="col-md-3">
								<a href="listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="images/custom/banner-22.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
							...
							<div class="col-md-3">
								<a href="#" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-06.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<ul class="nav nav-tabs nav-tabs--ys-center text-center" role="tablist">
							<li class="active"><a href="#Tab1"  role="tab" data-toggle="tab" class="text-uppercase">FEATURED</a></li>
							<li><a href="#Tab2" role="tab" data-toggle="tab" class="text-uppercase">new </a></li>
							<li><a href="#Tab3" role="tab" data-toggle="tab" class="text-uppercase">on Sale</a></li>							
						</ul>
						<!-- Tab panes -->
...
<div id="Tab1-clone" style="display:none">
	<!-- carousel -->
		...
		<div class="col-lg-3">
			...
			<div class="product">
				<div class="product__inside">
					<!-- product image -->
					<div class="product__inside__image">
						<a href="product.html"> <img src="images/product/product-21.jpg" alt=""> </a> 
						<!-- quick-view --> 
						<a href="#" data-toggle="modal" data-target="#quickViewModal" class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
						<!-- /quick-view --> 
					</div>
...
<div id="Tab2-clone" style="display:none">
	<!-- carousel -->
	<div class="carousel-products carouselTab slick-arrow-top row">
		<div class="col-lg-3">
			<!-- product -->
...
<div id="Tab3-clone" style="display:none">
	<!-- carousel -->
	<div class="carousel-products row carouselTab slick-arrow-top">
		<div class="col-lg-3">
			<!-- product -->
			<div class="product">
				<div class="product__inside">
	...
	<!-- /carousel -->						
			...
			<div class="container-fluid box-baners content">
				<div class="row">					
					<div class="col-xs-12">
						<!-- banner -->
						<a href="listing.html" class="banner banner-bg image-bg zoom-in" data-image="images/custom/banner-23.jpg">
							<span class="figure">
								<img src="images/custom/banner-23.jpg" alt=""/>
								<span class="figcaption">
									<span class="block-table">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-lg-6 col-xl-4">
							<h2 class="text-left text-uppercase title-under">RECENT POSTS</h2>
							<!--  -->							
							...
							<div class="recent-post-box recent-post-col row">
								...
								<div class="col-xs-6 col-sm-12 col-md-6">
									<div class="recent-post-box__text">
										<h4><a href="blog-post-right-column.html">Lorem ipsum</a></h4>
										<div class="author">by <b>Admin</b></div>
										<p>
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec eros tellus, scelerisque.
										</p>
							...
							<!-- / -->
							<a href="blog-post-right-column.html" class="btn btn-top btn--ys btn--xl">See all </a>
						</div>
						...
						<div class="col-xl-4 visible-xl">
							<h2 class="text-left text-uppercase title-under">testimonials</h2>
			...
			<!-- brands-carousel -->
			<div class="content container-fluid fill-bg">
				<div class="container">
					<div class="row">
				...
				<div class="row" >
					...
					<div class="col-sm-12 col-md-12  col-lg-3">
						...
						<div class="subscribe-box">
							<div class="mobile-collapse">
								<h4 class="text-left  title-under  mobile-collapse__title">NEWSLETTER SIGNUP<span class="hidden-xs">:</span></h4>
