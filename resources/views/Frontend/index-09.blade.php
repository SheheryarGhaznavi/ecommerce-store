...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-09.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:42 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
	...
	<body class="index">
		...
		<div id="pageContent">			
				...
				<div class="row">
					<div class="col-sm-12 col-md-7">
						...
						<div class="bannerOneProduct slick-arrow-bottom-wrapper">
							<!-- item -->
							<div>
								<img class="img-responsive" src="images/custom/banner-one-product_01.jpg" alt=""> 
							</div>
							<!-- /item -->
							<!-- item -->
							<div>
								<img class="img-responsive" src="images/custom/banner-one-product_02.jpg" alt=""> 
							</div>
							<!-- /item -->
							<!-- item -->
							<div>
								<img class="img-responsive" src="images/custom/banner-one-product_03.jpg" alt=""> 
							</div>
							<!-- /item -->
						</div>
						<!-- /bannerOneProduct -->
					...
					<div class="col-sm-12 col-md-5">
						<div class="product-content">
							<h2 class="title text-uppercase"><a href="#">The leather flap</a></h2>
							...
							<div class="clearfix ">
								...
								<div class="pull-left">
									<!-- product button -->
									<a href="#" data-toggle="modal" data-target="#modalAddToCart" class="btn btn-left btn--ys btn--l">
										<span class="icon icon-shopping_basket"></span> 
										Add to cart
									</a>	
									<!-- /product button -->
			...
			<!-- parallax-img -->
			<!-- parallax-img -->
			 <div class="content-big-indent content--parallax" data-image="images/custom/parallax-img-01.jpg"></div>
			<!-- /parallax-img -->
			<div class="content-big-indent">
				<div class="container">
					<div class="row">
...
Ut sit amet turpis. In est arcu, sollicitudin eu, vehicula venenatis, sociis natoque penatibus. Lorem ipsum dolor sit amet conse ctetur adipisicing elit
			...
			<!-- parallax-img -->
			 <div class="content-big-indent content--parallax" data-image="images/custom/parallax-img-02.jpg"></div>
			<!-- /parallax-img -->
			<div class="content-big-indent">
				<div class="container">
					<div class="row">
			...
			<!-- parallax-img -->
			 <div class="content-big-indent content--parallax" data-image="images/custom/parallax-img-03.jpg"></div>
			<!-- /parallax-img -->				
			...
			<!-- /INSTAGRAM -->	
			<!-- parallax-img -->
			 <div class="content-big-indent content--parallax" data-image="images/custom/parallax-img-04.jpg"></div>
			<!-- /parallax-img -->
		</div>
		<!-- End CONTENT section -->
		<!-- FOOTER section -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-6 col-lg-8">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="divider divider--lg hidden-xs"></div>
								<div class="mobile-collapse">
									<h4 class="text-left  title-under  mobile-collapse__title text-uppercase">Contacts</h4>
									<div class="v-links-list mobile-collapse__content">
					...
					<div class="col-xl-6 col-lg-4">
						<div class="mobile-collapse">
							<h4 class="text-left  title-under  mobile-collapse__title text-uppercase">Contact form</h4>
							<div class="mobile-collapse__content">
								<form  action="#" class="contact-form">
									...
									<!-- textarea -->
									<div class="form-group">
									    <label for="textareaMessage" class="sr-only">Message <sup>*</sup></label>
									    <textarea  class="form-control" rows="12" placeholder="Message"  id="textareaMessage"></textarea>
								   </div>
								   <!-- /textarea -->
								   <!-- button -->
								   <button class="btn btn--ys btn--xl btn-top" type="submit">Send</button>
								   <!-- /button -->						   
								</form>			
							</div>
						</div>
