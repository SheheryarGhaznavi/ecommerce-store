...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:32 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
						...
						<div class="banner-slider banner-slider-button">
							<div>
								<a href="listing.html" class="banner zoom-in font-size-responsive">
									<span class="figure">
										<img src="images/custom/banner-04.jpg" alt=""/>
							...
							<div>
								<a href="listing.html" class="banner zoom-in font-size-responsive">
									<span class="figure">
										<img src="images/custom/banner-05.jpg" alt=""/>
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						<div class="row">
							<div class="col-sm-6 col-md-6">
								<a href="listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-07.jpg" alt=""/>
										<span class="figcaption text-left">
											<span class="block-table">
												<span class="block-table-cell">
							...
							<div class="col-sm-6  col-md-6">
								<a href="listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-08.jpg" alt=""/>
										<span class="figcaption text-center">
											<span class="block-table">
												<span class="block-table-cell">
						...
						<div class="row">
							<div class="col-md-12">
								<a href="listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-09.jpg" alt=""/>
