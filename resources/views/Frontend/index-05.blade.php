...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-05.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:36 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
	...
	<body class="index">
				...
				<div class="tp-banner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/slides/05/slide-1.jpg"  alt="slide1"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" > 
							<!-- LAYERS --> 
							<!-- TEXT -->
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/slides/05/slide-2.jpg"  alt="slide2"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS -->
							<!-- TEXT -->
						...
						<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-saveperformance="off"  data-title="Slide">
							<!-- MAIN IMAGE --> 
							<img src="images/slides/05/slide-3.jpg"  alt="slide3"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
							<!-- LAYERS --> 
							<!-- TEXT -->
		...
		<div id="pageContent">
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<a href="listing.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/banner-11.jpg" alt=""/>
						...
						<a href="listing.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/banner-12.jpg" alt=""/>
								<span class="figcaption text-left">
									<span class="block-table">
										<span class="block-table-cell">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						...
						<a href="listing.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/banner-13.jpg" alt=""/>
								<span class="figcaption text-left">
									<span class="block-table">
										<span class="block-table-cell">
						...
						<a href="listing.html" class="banner zoom-in">
							<span class="figure">
								<img src="images/custom/banner-14.jpg" alt=""/>
			...
			<div class="container-fluid box-baners content">
				<div class="row">					
					<div class="col-xs-12">
						<!-- banner -->
						<a href="listing.html" class="banner banner-bg image-bg zoom-in" data-image="images/custom/banner-15.jpg">
							<span class="figure">
								<img src="images/custom/banner-15.jpg" alt=""/>
					...
					<div class="row">
						<div class="banner-carousel">
							<div class="col-md-4 col-sm-4 col-xs-12">
								<a href="listing.html" class="banner zoom-in">
								<span class="figure">
									<img src="images/custom/banner-16.jpg" alt=""/>
									<span class="figcaption">
										<span class="block-table">
											<span class="block-table-cell">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<a href="listing.html" class="banner zoom-in">
									<span class="figure">
										<img src="images/custom/banner-18.jpg" alt=""/>
										<span class="figcaption">
											<span class="block-table">
												<span class="block-table-cell">
		...
		<footer class="layout-3">
			...
			<div class="container inset-bottom-60">
				<div class="row">
					<div class="col-sm-12 text-center">
						<!--  Logo  --> 
						<a class="logo hidden-sm hidden-xs" href="index.html"> <img class="replace-2x" src="images/logo.png" alt="YOURStore"> </a> 
						<!-- /Logo -->
			...
			<div class="container footer-copyright">
				<div class="row">
					<div class="col-lg-12 text-center"> <a href="index.html"><span>Your</span>Store</a> &copy; 2016 . All Rights Reserved. </div>
				</div>
			</div>
			<!-- /footer-copyright --> 
