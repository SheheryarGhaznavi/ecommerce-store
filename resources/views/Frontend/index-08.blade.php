...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/index-08.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:43:40 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
				...
				<div class="container-fluid">					
					...
					<div class="row"  id="carouselHeader">
						...
						<div>						
							<div class="carousel-product-popup">
								...
								<div class="product-hover-popup">
									...
									<!-- /product price -->
									<!-- product button -->
									<a href="product.html"  class="btn btn--ys btn--xl">
										<span class="icon icon-shopping_basket"></span> 
										Add to cart
									</a>	
									<!-- /product button -->
						...
						<div>						
							<div class="carousel-product-popup">
								<!-- product image -->
								<div class="product__inside__image sold-out">
									<a href="product.html"><img src="images/product/product-23.jpg" alt=""> </a> 	
									<!-- label sold-out -->
						...
						<div>						
							<div class="carousel-product-popup">
								<!-- product image -->
								<div class="product__inside__image">
									<a href="product.html"><img src="images/product/product-24.jpg" alt=""> </a> 										
								</div>
								<!-- /product image --> 
								<!-- product hover-popup -->
								<div class="product-hover-popup">
									...
									<!-- /product price -->
									<!-- product button -->
									<a href="#" class="btn btn--ys btn--xl">
										<span class="icon icon-shopping_basket"></span> 
										Add to cart
									</a>	
									<!-- /product button -->
							...
							<div class="mobile-collapse">
								...
								<div class="mobile-collapse__content">
									<address class="font-medium">
										<span class="icon icon-call"></span> +777 2345 7885										
									</address>
									<div class="color-gray">7 Days a week from  10:00 am to 6:00 pm</div>
								</div>
							</div>
						</div>						
						<!-- /telephone -->
