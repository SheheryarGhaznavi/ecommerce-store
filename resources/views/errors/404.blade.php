...
<!-- Mirrored from ocean.tonytemplates.com/viktor/your_store_demo/html/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Apr 2018 01:40:33 GMT -->
<head>
		<!-- Basic -->
		<meta charset="utf-8">
		<title>YOURStore - 404 Not Found</title>
		...
		<link rel="stylesheet" href="/Frontend/external/slick/slick.css">
		<link rel="stylesheet" href="/Frontend/external/slick/slick-theme.css">
		<link rel="stylesheet" href="/Frontend/external/magnific-popup/magnific-popup.css">
		<link rel="stylesheet" href="/Frontend/external/nouislider/nouislider.css">
		<link rel="stylesheet" href="/Frontend/external/bootstrap-select/bootstrap-select.css">
		<!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
		<link rel="stylesheet" type="text/css" href="/Frontend/external/rs-plugin/css/settings.css" media="screen" />
		<!-- Custom CSS -->
		<link rel="stylesheet" href="/Frontend/css/style.css">
		<!-- Icon Fonts  -->
		<link rel="stylesheet" href="/Frontend/font/style.css">
		<!-- Head Libs -->
		<!-- Modernizr -->
		<script src="/Frontend/external/modernizr/modernizr.js"></script>
	</head>
	<body>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links-layout" role="menu">												
							<li class="col-one-fourth">
								...
								<a href="index.html">
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-1.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-2.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-3.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-4.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-5.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-6.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-7.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-8.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-9.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-10.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-11.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/layout-img-12.jpg" alt=""/><span class="btn btn--ys btn--lg">LAUNCH</span></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-fourth">
								<span class="image-link">
								<a href="listing.html">
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-1.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-2.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-3.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-4.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-5.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-6.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/listing-img-7.png" alt=""/></span>
							...
							<li class="col-one-fourth">
								...
								<span class="figure"><img class="img-responsive img-border" src="/Frontend/images/custom/listing-img-8.png" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/product-menu-img-1.png" alt=""/></span>
							...
							<li class="col-one-third">
								<span class="image-link">
								<a href="product.html">
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/product-menu-img-2.png" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/product-menu-img-3.png" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/blog-menu-img-1.png" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/blog-menu-img-2.png" alt=""/></span>
							...
							<li class="col-one-third">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/blog-menu-img-3.png" alt=""/></span>
					...
					<li>
						...
						<ul class="dropdown-menu megamenu image-links" role="menu">							
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/gallery-menu-img-1.png" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/gallery-menu-img-2.png" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/gallery-menu-img-3.png" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/gallery-menu-img-4.png" alt=""/></span>
							...
							<li class="col-one-fifth">
								...
								<span class="figure"><img class="img-responsive" src="/Frontend/images/custom/gallery-menu-img-5.png" alt=""/></span>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
							<!-- logo start --> 
							<a href="index.html"><img class="logo replace-2x img-responsive" src="/Frontend/images/logo.png" alt=""/> </a> 
							<!-- logo end --> 
						</div>
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<ul class="dropdown-menu megamenu" role="menu">
																	...
																	<div class="product">
																		<div class="product__inside">
																			...
																			<div class="product__inside__image">
																				<a href="product.html"> <img src="/Frontend/images/product/product-20.jpg" alt=""> </a> 																	
																			</div>
																			<!-- /product image --> 
																			<!-- product name -->
																...
																<div>
																	...
																	<div class="product">
																		<div class="product__inside">
																			<!-- product image -->
																			<div class="product__inside__image">
																				<a href="product.html"> <img src="/Frontend/images/product/product-2.jpg" alt=""> </a> 																		
																			</div>
																			<!-- /product image --> 
																			<!-- product name -->
																			<div class="product__inside__name">
																...
																<div>
																	...
																	<div class="product">
																		<div class="product__inside">
																			<!-- product image -->
																			<div class="product__inside__image">
																				<a href="product.html"> <img src="/Frontend/images/product/product-4.jpg" alt=""> </a>
													...
													<li class="col-sm-12 hidden-xs">
														<div class="row">
															<div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src="/Frontend/images/custom/banner-megamenu-01.jpg" alt=""/></a> </div>
															<div class="col-sm-6"> <a href="#" class="discolor-hover"><img class="img-responsive" src="/Frontend/images/custom/banner-megamenu-02.jpg" alt=""/></a> </div>
														</div>
													</li>
												</ul>
											</li>
												...
												<ul class="dropdown-menu megamenu" role="menu">
													...
													<li class="col-sm-3">												
														<a href="listing.html" class="megamenu__subtitle">
															<span>TOPS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="/Frontend/images/custom/mens-category-1.jpg" alt=""/></span>
														</a>
													...
													<li class="col-sm-3">
														<a href="listing.html" class="megamenu__subtitle">
															<span>BOTTOMS</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="/Frontend/images/custom/mens-category-2.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Trousers</a></li>
													...
													<li class="col-sm-3">
														<a href="#" class="megamenu__subtitle">
															<span>ACCESSORIES</span>
															<span class="megamenu__category-image hidden-xs"><img class="img-responsive" src="/Frontend/images/custom/mens-category-3.jpg" alt=""/></span>
														</a>
														<ul class="megamenu__submenu megamenu__submenu--marked">
															<li class="dl-back"><a href="#"><span class="icon icon-chevron_left"></span>back</a></li>
															<li class="level2"><a href="listing.html">Bags</a></li>
													...
													<li class="col-sm-3 hidden-xs">
														...
														<div class="vertical-carousel vertical-carousel-1 special-carousel">
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="/Frontend/images/product/product-120x150-1.jpg" alt=""></a></div>
															...
															<div class="vertical-carousel__item">
																<div class="vertical-carousel__item__image pull-left"><a href="product.html"><img src="/Frontend/images/product/product-120x150-2.jpg" alt=""></a></div>
																<div class="product__label product__label--sale"> <span>Sale</span></div>
																<div class="vertical-carousel__item__title">
													...
													<li class="col-sm-12 hidden-xs">
														...
														<ul class="list-inline brands-list">
															<li><a href="#"><img src="/Frontend/images/custom/brand-01.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-03.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-02.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-05.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-04.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-06.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-07.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-08.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-09.png" alt=""></a></li>
															<li><a href="#"><img src="/Frontend/images/custom/brand-10.png" alt=""></a></li>
														</ul>
													</li>
												</ul>
											</li>
										...
										<div class="dropdown text-right">
											...
											<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
												<div class="container">
													...
													<ul>
														<li class="cart__item">
															<div class="cart__item__image pull-left"><a href="#"><img src="/Frontend/images/product/product-1.jpg" alt=""/></a></div>
														...
														<li class="cart__item">
															<div class="cart__item__image pull-left"><a href="#"><img src="/Frontend/images/product/product-2.jpg" alt=""/></a></div>
															<div class="cart__item__control">
																<div class="cart__item__delete"><a href="#" class="icon icon-delete"><span>Delete</span></a></div>
																<div class="cart__item__edit"><a href="#" class="icon icon-edit"><span>Edit</span></a></div>
															</div>
		...
		<div id="pageContent">
			<div class="container">				
				...
				<div class="text-center"> 
		          <img src="/Frontend/images/page-404-icon.png" alt="empty cart icon" class="img-responsive-inline" />
				...
				<div class="row" >
					<div class="col-sm-12 col-md-5 col-lg-6 border-sep-right">
						<div class="footer-logo hidden-xs">
							<!--  Logo  --> 
							<a class="logo" href="index.html"> <img class="replace-2x" src="/Frontend/images/logo.png"  alt="YOURStore"> </a> 
							<!-- /Logo --> 
						</div>
						<div class="box-about">
		...
		<!-- External JS --> 
		<!-- jQuery 1.10.1--> 
		<script src="/Frontend/external/jquery/jquery-2.1.4.min.js"></script> 
		<!-- Bootstrap 3--> 
		<script src="/Frontend/external/bootstrap/bootstrap.min.js"></script> 
		<!-- Specific Page External Plugins --> 
		<script src="/Frontend/external/slick/slick.min.js"></script> 
		<script src="/Frontend/external/countdown/jquery.plugin.min.js"></script> 
		<script src="/Frontend/external/countdown/jquery.countdown.min.js"></script> 		
		<script src="/Frontend/external/instafeed/instafeed.min.js"></script> 
		<script src="/Frontend/external/magnific-popup/jquery.magnific-popup.min.js"></script> 
		<script src="/Frontend/external/nouislider/nouislider.min.js"></script>
		<script src="/Frontend/external/isotope/isotope.pkgd.min.js"></script> 
		<script src="/Frontend/external/imagesloaded/imagesloaded.pkgd.min.js"></script>
		<script src="/Frontend/external/colorbox/jquery.colorbox-min.js"></script>
		<!-- Custom --> 
